...
export const  AddTrack = ({visible,setVisible}) => {
    ...
    const handleTrack = () => {
        try {   
            ...
            axios.post(`http://localhost:5000/track/add?artist_id=${artistDetails[0]?.artist_id}`,formData,{
                headers:{
    ...
    if(visible == true){
        document.body.classList.add('fade-background'); // Apply to body
    }else{
        ...
        <div>
            {
                <div className="form-container" id="songForm">
                        ...
                        <button id="submitSong" onClick={() => handleTrack()} className="submit-btn">
                            Add Song
                        </button>
                        
                            <button classNameName="cancel-btn" id="cancelSong" onClick={() => setVisible((prev) => !prev)}>
                                Cancel
                            </button>
                        </div>
                    </div>
